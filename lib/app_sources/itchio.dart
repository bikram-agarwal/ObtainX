...
class ItchIO extends AppSource {
  ...
  Future<List<(String, String, bool)>> _extractDownload(String body) async {
    final parser = await parseHtmlOffIsolate(body);
  ...
  Future<String> _getDownloadPageBody(
    ...
    final ids = await _extractDownload(currentBody);
  ...
  Future<APKDetails> getLatestAPKDetails(
    ...
    try {
      ...
      final Document storePage = await parseHtmlOffIsolate(body);
      ...
      final downloadIds = await _extractDownload(downloadPageBody);
